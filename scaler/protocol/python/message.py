...
class DebugCommand(Message):
    ...
    @staticmethod
    def new_msg(command: bytes) -> "DebugCommand":
        return DebugCommand(_message.DebugCommand(command=command))


class DebugCommandResponse(Message):
    def __init__(self, msg):
        super().__init__(msg)
    ...
    @staticmethod
    def new_msg(response: bytes) -> "DebugCommandResponse":
        return DebugCommandResponse(_message.DebugCommandResponse(response=response))
...
PROTOCOL: bidict.bidict[str, Type[Message]] = bidict.bidict(
    {
        ...
        "debugCommandResponse": DebugCommandResponse,
    }
)
