...
struct InformationCommand {
    command @0 :Data;
}

struct InformationCommandResponse {
    response @0 :Data;
}
...
struct Message {
    union {
        ...
        informationCommand @25 :InformationCommand;
        informationCommandResponse @26 :InformationCommandResponse;
    }
}
