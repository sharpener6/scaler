...
class TaskData:
    ...
    def populate(self, state: StateTask, profiling_data: Optional[ProfileResult], task_capabilities: Dict[str, int]):
...
class TaskLogTable:
    ...
    def handle_task_state(self, state_task: StateTask):
        ...
        row = TaskData()
        row.populate(state_task, profiling_data, state_task.capabilities)
