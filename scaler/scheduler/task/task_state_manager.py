...
class TaskStateManager:
    ...
    def get_state_machine(self, task_id: TaskID) -> TaskStateMachine:
        return self._task_id_to_state_machine[task_id]

    def has_state_machine(self, task_id: TaskID) -> bool:
        return True if self._task_id_to_state_machine.get(task_id, None) is not None else False
