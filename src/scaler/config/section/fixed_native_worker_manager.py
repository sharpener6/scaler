...
class FixedNativeWorkerManagerConfig(ConfigClass):
    ...
    def __post_init__(self) -> None:
        ...
        if self.worker_manager_config.max_workers < 0:
            raise ValueError("max_workers must be >=0 for fixed native worker manager")
