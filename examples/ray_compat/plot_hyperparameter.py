"""
This example was copied from https://docs.ray.io/en/latest/ray-core/examples/plot_hyperparameter.html
...
def get_data_loaders(batch_size):
    ...
    test_loader = torch.utils.data.DataLoader(
        datasets.MNIST("~/data", train=False, transform=mnist_transforms), batch_size=batch_size, shuffle=True
    )
